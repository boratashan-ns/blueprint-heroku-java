package com.blueprints.heroku.views.sampleholder;
...
@PageTitle("Sample holder")
@Route(value = "sampleholder", layout = MainLayout.class)
@RouteAlias(value = "", layout = MainLayout.class)
public class SampleHolderView extends HorizontalLayout {
